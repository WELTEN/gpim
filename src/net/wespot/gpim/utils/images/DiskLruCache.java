 ...
 *         value.
 * </ul>
 * Every {@link #edit} call must be matched by a call to {@link net.wespot.gpim.utils.images.DiskLruCache.Editor#commit}
 * or {@link net.wespot.gpim.utils.images.DiskLruCache.Editor#abort}. Committing is atomic: a read observes the full set
